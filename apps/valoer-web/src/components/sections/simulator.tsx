      ...
      <div className="grid grid-cols-2 rounded-md bg-cloud p-1" role="tablist" aria-label="Tipo de solução">
        {(["consorcio", "seguro"] as Mode[]).map((m) => (
          <button
            ...
            className={cn(
              "rounded-[7px] py-2.5 text-sm font-semibold transition duration-200 ease-out",
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {tipos.map((t, i) => (
            <button
              ...
              className={cn(
                "rounded-pill border px-4 py-2 text-sm font-medium transition duration-200 ease-out",
                tipoIndex === i
